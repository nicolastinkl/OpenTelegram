...
public final class HttpUrl {
    ...
    public HttpUrl(String scheme, String username, String password, String host, int i, List<String> pathSegments, List<String> list, String str, String url) {
        ...
        this.fragment = str;
        this.url = url;
        this.isHttps = Intrinsics.areEqual(scheme, CosXmlServiceConfig.HTTPS_PROTOCOL);
    }
    ...
    public static final class Builder {
        ...
        public final Builder scheme(String scheme) {
            ...
            boolean equals2;
            Intrinsics.checkNotNullParameter(scheme, "scheme");
            equals = StringsKt__StringsJVMKt.equals(scheme, CosXmlServiceConfig.HTTP_PROTOCOL, true);
            if (equals) {
                setScheme$okhttp(CosXmlServiceConfig.HTTP_PROTOCOL);
            } else {
                equals2 = StringsKt__StringsJVMKt.equals(scheme, CosXmlServiceConfig.HTTPS_PROTOCOL, true);
                if (!equals2) {
                    throw new IllegalArgumentException(Intrinsics.stringPlus("unexpected scheme: ", scheme));
                }
                setScheme$okhttp(CosXmlServiceConfig.HTTPS_PROTOCOL);
            }
            return this;
        }
    ...
    public static final class Companion {
        ...
        public final int defaultPort(String scheme) {
            Intrinsics.checkNotNullParameter(scheme, "scheme");
            if (Intrinsics.areEqual(scheme, CosXmlServiceConfig.HTTP_PROTOCOL)) {
                return 80;
            }
            return Intrinsics.areEqual(scheme, CosXmlServiceConfig.HTTPS_PROTOCOL) ? 443 : -1;
        }
