        ...
        public Factory(long j, Request request, Response response) {
            ...
            if (response != null) {
                ...
                while (i < size) {
                    ...
                    equals = StringsKt__StringsJVMKt.equals(name, com.tencent.cos.xml.crypto.Headers.DATE, true);
                    if (equals) {
                        ...
                        if (equals2) {
                            ...
                            equals3 = StringsKt__StringsJVMKt.equals(name, com.tencent.cos.xml.crypto.Headers.LAST_MODIFIED, true);
                            if (equals3) {
                                this.lastModified = DatesKt.toHttpDateOrNull(value);
                                this.lastModifiedString = value;
                            } else {
                                equals4 = StringsKt__StringsJVMKt.equals(name, com.tencent.cos.xml.crypto.Headers.ETAG, true);
                                if (equals4) {
                                    this.etag = value;
                                } else {
