...
public class ConstraintLayout extends ViewGroup {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected void applyConstraintsFromLayoutParams(boolean r18, android.view.View r19, androidx.constraintlayout.solver.widgets.ConstraintWidget r20, androidx.constraintlayout.widget.ConstraintLayout.LayoutParams r21, android.util.SparseArray<androidx.constraintlayout.solver.widgets.ConstraintWidget> r22) {
        /*
    ...
    protected void resolveMeasuredDimension(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            if (z) {
                min |= ConnectionsManager.FileTypePhoto;
            }
            if (z2) {
                min2 |= ConnectionsManager.FileTypePhoto;
            }
