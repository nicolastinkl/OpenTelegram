...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private boolean hasVoiceSearch() {
        ...
        return (intent == null || getContext().getPackageManager().resolveActivity(intent, CharacterCompat.MIN_SUPPLEMENTARY_CODE_POINT) == null) ? false : true;
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = inputType | CharacterCompat.MIN_SUPPLEMENTARY_CODE_POINT | 524288;
            }
        }
