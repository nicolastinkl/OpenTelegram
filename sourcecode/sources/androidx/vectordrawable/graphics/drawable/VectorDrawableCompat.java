...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int min = Math.min(LiteMode.FLAG_AUTOPLAY_GIFS, (int) (this.mTmpBounds.width() * abs));
        int min2 = Math.min(LiteMode.FLAG_AUTOPLAY_GIFS, (int) (this.mTmpBounds.height() * abs2));
        if (min <= 0 || min2 <= 0) {
            return;
        }
