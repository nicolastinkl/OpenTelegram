...
public class SecretChatHelper extends BaseController {
    ...
    private static volatile SecretChatHelper[] Instance = new SecretChatHelper[1];
    ...
    protected void processUpdateEncryption(TLRPC$TL_updateEncryption tLRPC$TL_updateEncryption, ConcurrentHashMap<Long, TLRPC$User> concurrentHashMap) {
        byte[] bArr;
