...
public class NotificationCenter {
    ...
    public static int updateCurrentIpAndPort;
    ...
    public int setAnimationInProgress(int i, int[] iArr, boolean z) {
        ...
        if (this.heavyOperationsCounter.isEmpty() && z) {
            getGlobalInstance().postNotificationName(stopAllHeavyOperations, Integer.valueOf(LiteMode.FLAG_CALLS_ANIMATIONS));
        }
    ...
    public void onAnimationFinish(int i) {
        ...
        if (allowedNotifications != null) {
            ...
            if (!this.heavyOperationsCounter.isEmpty()) {
                ...
                if (this.heavyOperationsCounter.isEmpty()) {
                    getGlobalInstance().postNotificationName(startAllHeavyOperations, Integer.valueOf(LiteMode.FLAG_CALLS_ANIMATIONS));
                }
            }
    ...
    public static void listenEmojiLoading(final View view) {
        ...
        view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.messenger.NotificationCenter.1
            ...
            public void onViewAttachedToWindow(View view2) {
                NotificationCenter.getGlobalInstance().addObserver(NotificationCenterDelegate.this, NotificationCenter.emojiLoaded);
            }

            @Override // android.view.View.OnAttachStateChangeListener
            public void onViewDetachedFromWindow(View view2) {
                NotificationCenter.getGlobalInstance().removeObserver(NotificationCenterDelegate.this, NotificationCenter.emojiLoaded);
            }
        });
    }
    ...
    public void listenOnce(final int i, final Runnable runnable) {
        final NotificationCenterDelegate[] notificationCenterDelegateArr = new NotificationCenterDelegate[1];
        notificationCenterDelegateArr[0] = new NotificationCenterDelegate() { // from class: org.telegram.messenger.NotificationCenter$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.NotificationCenter.NotificationCenterDelegate
