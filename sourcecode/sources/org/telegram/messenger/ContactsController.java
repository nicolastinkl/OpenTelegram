...
public class ContactsController extends BaseController {
    private static volatile ContactsController[] Instance = new ContactsController[1];
    ...
    public void checkAppAccount() {
        ...
        try {
            Account[] accountsByType = accountManager.getAccountsByType("com.tglime.fqkaso");
        ...
        if (getUserConfig().isClientActivated()) {
            ...
            if (this.systemAccount == null) {
                try {
                    Account account2 = new Account("" + getUserConfig().getClientUserId(), "com.tglime.fqkaso");
    ...
    public void resetImportedContacts() {
        ...
        }, new RequestDelegate() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda62
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:141:0x058b A[Catch: all -> 0x05a3, TRY_LEAVE, TryCatch #2 {all -> 0x05a3, blocks: (B:139:0x0586, B:141:0x058b), top: B:138:0x0586 }] */
    /* JADX WARN: Removed duplicated region for block: B:145:0x0590 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
    ...
    */
        ...
        while (i5 < arrayList.size()) {
            ...
            if (tLRPC$User == null) {
                ...
                if (hashMap == null || TextUtils.isEmpty(tLRPC$User.phone)) {
                    ...
                    i3 = 0;
                    hashMap2.put(tLRPC$User.phone.substring(Math.max(0, r2.length() - 7)), tLRPC$TL_contact2);
                }
    ...
    public /* synthetic */ void lambda$mergePhonebookAndTelegramContacts$41(ArrayList arrayList, HashMap hashMap, final HashMap hashMap2, final ArrayList arrayList2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (user != null && !TextUtils.isEmpty(user.phone)) {
                Contact contact = (Contact) hashMap.get(user.phone.substring(Math.max(0, r4.length() - 7)));
                if (contact != null) {
        ...
        while (it.hasNext()) {
            Collections.sort((ArrayList) it.next(), new Comparator() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda49
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
