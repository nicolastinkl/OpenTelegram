...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, FloatingDebugProvider {
    private static FrameLayout bivLink;
    private static BackupImageView bivLinkImage;
    public static WebView discoverWebView;
    ...
    private ActionBarMenuItem addFriendItem;
    ...
    public static boolean[] dialogsLoaded = new boolean[1];
    private static final Interpolator interpolator = new Interpolator() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda40
    ...
    public static /* synthetic */ boolean lambda$createActionMode$35(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    static /* synthetic */ int access$16908(DialogsActivity dialogsActivity) {
        int i = dialogsActivity.currentRetryCount;
        dialogsActivity.currentRetryCount = i + 1;
        return i;
    }
    ...
    class ContentView extends SizeNotifierFrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            DialogsActivity.this.rightSlidingDialogContainer.setCurrentTop(i2);
            DialogsActivity dialogsActivity = DialogsActivity.this;
            if (!dialogsActivity.whiteActionBar) {
                if (!((BaseFragment) dialogsActivity).inPreviewMode) {
                    if (DialogsActivity.this.progressToActionMode > 0.0f) {
                        ...
                        rect.set(0, i, getMeasuredWidth(), i2);
                        drawBlurRect(canvas, 0.0f, rect, this.actionBarSearchPaint, true);
                    } else {
                        Rect rect2 = AndroidUtilities.rectTmp2;
                        rect2.set(0, i, getMeasuredWidth(), i2);
                        drawBlurRect(canvas, 0.0f, rect2, DialogsActivity.this.actionBarDefaultPaint, true);
                    }
                }
            } else {
                ...
                rect3.set(0, i, getMeasuredWidth(), i2);
                drawBlurRect(canvas, 0.0f, rect3, DialogsActivity.this.searchAnimationProgress == 1.0f ? this.actionBarSearchPaint : DialogsActivity.this.actionBarDefaultPaint, true);
            ...
            if (dialogsActivity3.whiteActionBar && dialogsActivity3.searchAnimationProgress > 0.0f && DialogsActivity.this.searchAnimationProgress < 1.0f && DialogsActivity.this.searchTabsView != null) {
                ...
                canvas.drawRect(0.0f, i2, getMeasuredWidth(), i + ((BaseFragment) DialogsActivity.this).actionBar.getMeasuredHeight() + DialogsActivity.this.searchTabsView.getMeasuredHeight(), this.windowBackgroundPaint);
            }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent != null && motionEvent.getAction() == 0 && !DialogsActivity.this.startedTracking && !DialogsActivity.this.maybeStartTracking && DialogsActivity.this.filterTabsView.getVisibility() == 0) {
                ...
                if (DialogsActivity.this.startedTracking) {
                    ...
                    DialogsActivity.this.tabsAnimation.setDuration(Math.max(ImageReceiver.DEFAULT_CROSSFADE_DURATION, Math.min(measuredWidth2, BannerConfig.SCROLL_TIME)));
                            ...
                            if (tLRPC$Dialog != null) {
                                if (SharedConfig.getChatSwipeAction(((BaseFragment) DialogsActivity.this).currentAccount) != 1) {
                                    if (SharedConfig.getChatSwipeAction(((BaseFragment) DialogsActivity.this).currentAccount) != 3) {
                                        ...
                                        DialogsActivity dialogsActivity = DialogsActivity.this;
                                        dialogsActivity.canMuteCount = !MessagesController.getInstance(((BaseFragment) dialogsActivity).currentAccount).isDialogMuted(dialogId, 0) ? 1 : 0;
                                        DialogsActivity dialogsActivity2 = DialogsActivity.this;
    ...
    public boolean onFragmentCreate() {
        ...
        this.qbadgeTimer = timer;
        timer.schedule(new TimerTask() { // from class: org.telegram.ui.DialogsActivity.2
            @Override // java.util.TimerTask, java.lang.Runnable
            public void run() {
                DialogsActivity.this.applyUnreadCount();
            }
        }, 0L, 10000L);
    ...
    private void loadHomeLink() {
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLObject() { // from class: org.telegram.tgnet.TLRPC$JMT_request_home_link
            public static int constructor = -737377227;

            @Override // org.telegram.tgnet.TLObject
            public TLObject deserializeResponse(AbstractSerializedData abstractSerializedData, int i, boolean z) {
                return TLRPC$JMT_response_home_link.TLdeserialize(abstractSerializedData, i, z);
            }
        ...
        }, new RequestDelegate(this) { // from class: org.telegram.ui.DialogsActivity.3
            @Override // org.telegram.tgnet.RequestDelegate
            public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable(this) { // from class: org.telegram.ui.DialogsActivity.3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (tLRPC$TL_error == null) {
                            TLObject tLObject2 = tLObject;
                            if (tLObject2 instanceof TLRPC$JMT_response_home_link) {
                                BuildVars.homeLink = (TLRPC$JMT_response_home_link) tLObject2;
                                DialogsActivity.updateLinkButton();
                                return;
                            } else {
                                BuildVars.homeLink = null;
                                DialogsActivity.updateLinkButton();
                                return;
                            }
                        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void applyUnreadCount() {
        if (this.isRequestUnreadCount) {
            return;
        }
        this.isRequestUnreadCount = true;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLObject() { // from class: org.telegram.tgnet.TLRPC$JMT_applyUnread_req
            public static int constructor = 1743558281;

            @Override // org.telegram.tgnet.TLObject
            public TLObject deserializeResponse(AbstractSerializedData abstractSerializedData, int i, boolean z) {
                return TLRPC$JMTInt32.TLdeserialize(abstractSerializedData, i, z);
            }
        ...
        }, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity.4
            @Override // org.telegram.tgnet.RequestDelegate
            public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                DialogsActivity.this.isRequestUnreadCount = false;
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity.4.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (tLRPC$TL_error != null) {
                            DialogsActivity.this.qbadgeView.setBadgeNumber(0);
                            return;
                        }
                        TLObject tLObject2 = tLObject;
                        if (!(tLObject2 instanceof TLRPC$JMTInt32)) {
                            DialogsActivity.this.qbadgeView.setBadgeNumber(0);
                        } else {
                            DialogsActivity.this.qbadgeView.setBadgeNumber(((TLRPC$JMTInt32) tLObject2).v);
                        }
                    }
                });
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void retrySetChannel() {
        int i = BuildVars.controlInstallSDK;
        if (i == 1) {
            OpenInstall.getInstallCanRetry(new AppInstallRetryAdapter() { // from class: org.telegram.ui.DialogsActivity.5
                @Override // com.fm.openinstall.listener.AppInstallRetryAdapter
                public void onInstall(AppData appData, boolean z) {
                    String channel = appData.getChannel();
                    if (z) {
                        if (DialogsActivity.this.currentRetryCount >= 5) {
                            DialogsActivity.this.realRetrySetChannel(channel);
                            return;
                        } else {
                            DialogsActivity.access$16908(DialogsActivity.this);
                            DialogsActivity.this.retrySetChannel();
                            return;
                        }
                    }
                    DialogsActivity.this.realRetrySetChannel(channel);
            ...
            XInstall.getInstallParam(new XInstallListener() { // from class: org.telegram.ui.DialogsActivity.6
                ...
                public void onInstallFinish(XAppData xAppData, XAppError xAppError) {
                    ...
                    if (TextUtils.isEmpty(channelCode)) {
                        if (DialogsActivity.this.currentRetryCount >= 5) {
                            DialogsActivity.this.realRetrySetChannel(channelCode);
                            return;
                        } else {
                            DialogsActivity.access$16908(DialogsActivity.this);
                            DialogsActivity.this.retrySetChannel();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void realRetrySetChannel(final String str) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.d("开始请求：JMT_setChannelCode，channelCode=" + str);
        }
        TLRPC$JMT_setChannelCode tLRPC$JMT_setChannelCode = new TLRPC$JMT_setChannelCode();
        tLRPC$JMT_setChannelCode.channel_code = str;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$JMT_setChannelCode, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity.7
            @Override // org.telegram.tgnet.RequestDelegate
            public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity.7.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (tLRPC$TL_error == null) {
                            if (tLObject instanceof TLRPC$TL_boolTrue) {
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.d("请求成功：JMT_setChannelCode，设置成功");
                                    return;
                                }
                                return;
                            } else {
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.d("请求成功：JMT_setChannelCode，设置失败，再次请求");
                                }
                                AnonymousClass7 anonymousClass7 = AnonymousClass7.this;
                                DialogsActivity.this.realRetrySetChannel(str);
                                return;
                            }
                        }
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.d("请求成功：JMT_setChannelCode，设置失败:" + tLRPC$TL_error.text + "，再次请求");
                        }
    ...
    public static void showNewUserHint() {
        if (mContext != null && BuildVars.isFirstPrivateChatHint) {
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
            builder.setTitle(LocaleController.getString("PasswordHintPlaceholder", R.string.PasswordHintPlaceholder));
            builder.setMessage(LocaleController.getString("JMTNewUserHint", R.string.JMTNewUserHint));
            builder.setNegativeButton(LocaleController.getString("JMTNewUserCancel", R.string.JMTNewUserCancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity.8
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    TLRPC$JMT_readDistribute tLRPC$JMT_readDistribute = new TLRPC$JMT_readDistribute();
                    tLRPC$JMT_readDistribute.type = "1";
                    ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$JMT_readDistribute, new RequestDelegate(this) { // from class: org.telegram.ui.DialogsActivity.8.1
                        @Override // org.telegram.tgnet.RequestDelegate
            ...
            builder.setPositiveButton(LocaleController.getString("JMTNewUserContinue", R.string.JMTNewUserContinue), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity.9
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    TLRPC$JMT_readDistribute tLRPC$JMT_readDistribute = new TLRPC$JMT_readDistribute();
                    tLRPC$JMT_readDistribute.type = "2";
                    ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$JMT_readDistribute, new RequestDelegate(this) { // from class: org.telegram.ui.DialogsActivity.9.1
                        @Override // org.telegram.tgnet.RequestDelegate
                        public void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                        }
                    });
            ...
            builder.show();
            new CountDownTimer(5000L, 1000L) { // from class: org.telegram.ui.DialogsActivity.10
                @Override // android.os.CountDownTimer
                public void onTick(long j) {
                    create.messageTextView.setText(LocaleController.getString("JMTNewUserHint", R.string.JMTNewUserHint) + "(" + (j / 1000) + "s)");
                }
                ...
                public void onFinish() {
                    if (create.isShowing()) {
                        create.dismiss();
                        TLRPC$JMT_readDistribute tLRPC$JMT_readDistribute = new TLRPC$JMT_readDistribute();
                        tLRPC$JMT_readDistribute.type = "3";
                        ConnectionsManager.getInstance(UserConfig.selectedAccount).sendRequest(tLRPC$JMT_readDistribute, new RequestDelegate(this) { // from class: org.telegram.ui.DialogsActivity.10.1
                            @Override // org.telegram.tgnet.RequestDelegate
                            public void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
                            }
                        });
    ...
    public void updateStatus(TLRPC$User tLRPC$User, boolean z) {
        ...
        if (emojiStatusDocumentId != null) {
            ...
            if (this.premiumStar == null) {
                ...
                this.premiumStar = new AnimatedEmojiDrawable.WrapSizeDrawable(this, this.premiumStar, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f)) { // from class: org.telegram.ui.DialogsActivity.11
    ...
    public void onFragmentDestroy() {
        ...
        this.qbadgeTimer.cancel();
        this.isRequestUnreadCount = false;
        WebView webView = discoverWebView;
        if (webView != null) {
    ...
    public ActionBar createActionBar(Context context) {
        ActionBar actionBar = new ActionBar(context) { // from class: org.telegram.ui.DialogsActivity.12
    ...
    public static void updateLinkButton() {
        if (bivLink == null) {
            return;
        }
        TLRPC$JMT_response_home_link tLRPC$JMT_response_home_link = BuildVars.homeLink;
        if (tLRPC$JMT_response_home_link == null) {
            bivLink.setVisibility(8);
            return;
        }
        bivLinkImage.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tLRPC$JMT_response_home_link.cover.sizes, AndroidUtilities.getPhotoSize()), tLRPC$JMT_response_home_link.cover), "40_40", (Drawable) null, (Object) null);
        bivLink.setVisibility(0);
    }

    public static void updateTitleText(String str) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x06d9, code lost:
    
        if (r40.initialDialogsType == 10) goto L147;
     */
    ...
    /* JADX WARN: Removed duplicated region for block: B:142:0x0b0a  */
    /* JADX WARN: Removed duplicated region for block: B:145:0x0b18  */
    /* JADX WARN: Removed duplicated region for block: B:149:0x0b39  */
    /* JADX WARN: Removed duplicated region for block: B:152:0x0b51  */
    /* JADX WARN: Removed duplicated region for block: B:156:0x0b75  */
    /* JADX WARN: Removed duplicated region for block: B:160:0x0c21  */
    /* JADX WARN: Removed duplicated region for block: B:163:0x0c6e  */
    /* JADX WARN: Removed duplicated region for block: B:167:0x0c7f  */
    /* JADX WARN: Removed duplicated region for block: B:171:0x0cc7  */
    /* JADX WARN: Removed duplicated region for block: B:174:0x0cd7  */
    /* JADX WARN: Removed duplicated region for block: B:182:0x0d5c  */
    /* JADX WARN: Removed duplicated region for block: B:185:0x0d91  */
    /* JADX WARN: Removed duplicated region for block: B:189:0x0d67  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:245:0x082f  */
    /* JADX WARN: Removed duplicated region for block: B:246:0x07ea  */
    /* JADX WARN: Removed duplicated region for block: B:247:0x076d  */
    /* JADX WARN: Removed duplicated region for block: B:248:0x0717  */
    /* JADX WARN: Removed duplicated region for block: B:249:0x070e  */
    ...
    */
    ...
    class AnonymousClass16 extends FilterTabsView {
    ...
    class AnonymousClass17 implements FilterTabsView.FilterTabsViewDelegate {
        ...
        public void lambda$didSelectTab$6(final MessagesController.DialogFilter dialogFilter) {
            ...
            builder.setPositiveButton(LocaleController.getString("Delete", R.string.Delete), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$17$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.AnonymousClass17.this.lambda$showDeleteAlert$0(dialogFilter, dialogInterface, i);
                }
            });
        ...
        */
        public boolean didSelectTab(org.telegram.ui.Components.FilterTabsView.TabView r19, boolean r20) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.DialogsActivity.AnonymousClass17.didSelectTab(org.telegram.ui.Components.FilterTabsView$TabView, boolean):boolean");
        }
    ...
    /* renamed from: org.telegram.ui.DialogsActivity$20, reason: invalid class name */
    class AnonymousClass20 extends LinearLayoutManager {
        private boolean fixOffset;
        final /* synthetic */ ViewPage val$viewPage;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass20(Context context, ViewPage viewPage) {
            super(context);
        ...
        */
        public int scrollVerticallyBy(int r18, androidx.recyclerview.widget.RecyclerView.Recycler r19, androidx.recyclerview.widget.RecyclerView.State r20) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.DialogsActivity.AnonymousClass20.scrollVerticallyBy(int, androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State):int");
        }
        ...
        public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$20$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.AnonymousClass20.lambda$onLayoutChildren$0(DialogsActivity.ViewPage.this);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void lambda$createView$7(ViewPage viewPage, View view, int i) {
        ...
        if (!(view instanceof DialogsHintCell) || ((viewPage.dialogsType != 7 && viewPage.dialogsType != 8) || (chatlistUpdate = viewPage.dialogsAdapter.getChatlistUpdate()) == null)) {
    ...
    class AnonymousClass28 implements DialogsSearchAdapter.DialogsSearchAdapterDelegate {
        AnonymousClass28() {
        }
        ...
        public void needRemoveHint(final long j) {
            ...
            builder.setPositiveButton(LocaleController.getString("StickersRemove", R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$28$$ExternalSyntheticLambda2
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DialogsActivity.AnonymousClass28.this.lambda$needRemoveHint$0(j, dialogInterface, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
            AlertDialog create = builder.create();
        ...
        public void needClearList() {
            ...
            if (DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isSearchWas() && DialogsActivity.this.searchViewPager.dialogsSearchAdapter.isRecentSearchDisplayed()) {
                ...
                builder.setPositiveButton(LocaleController.getString("Clear", R.string.Clear), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$28$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.AnonymousClass28.this.lambda$needClearList$1(dialogInterface, i);
                    }
                });
            } else {
                builder.setTitle(LocaleController.getString("ClearSearchAlertTitle", R.string.ClearSearchAlertTitle));
                builder.setMessage(LocaleController.getString("ClearSearchAlert", R.string.ClearSearchAlert));
                builder.setPositiveButton(LocaleController.getString("ClearButton", R.string.ClearButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$28$$ExternalSyntheticLambda0
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        DialogsActivity.AnonymousClass28.this.lambda$needClearList$2(dialogInterface, i);
                    }
                });
            }
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    public /* synthetic */ void lambda$createView$11(View view) {
        ...
        presentFragment(new JMTDiscoverActivity());
    }
    ...
    public void getIsBindPhone() {
        if (BuildVars.isNeedBindPhone) {
            TLRPC$JMT_isBoundPhone tLRPC$JMT_isBoundPhone = new TLRPC$JMT_isBoundPhone();
            tLRPC$JMT_isBoundPhone.ext = "";
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tLRPC$JMT_isBoundPhone, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity.40
                @Override // org.telegram.tgnet.RequestDelegate
                public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity.40.1
                        @Override // java.lang.Runnable
                        public void run() {
                            if (tLRPC$TL_error == null) {
                                TLObject tLObject2 = tLObject;
                                if (tLObject2 instanceof TLRPC$JMT_jAuthIsBoundPhone) {
                                    ...
                                    if (tLRPC$JMT_jAuthIsBoundPhone.require_level == 0 || tLRPC$JMT_jAuthIsBoundPhone.bound == 1) {
                                        return;
                                    }
                                    DialogsActivity.this.presentFragment(new JMTBindPhoneActivity());
                                }
                            }
                        }
                    });
    ...
    public void showSelectStatusDialog() {
        ...
        int i3 = i2;
        SelectAnimatedEmojiDialog selectAnimatedEmojiDialog = new SelectAnimatedEmojiDialog(this, getContext(), true, Integer.valueOf(i), 0, getResourceProvider()) { // from class: org.telegram.ui.DialogsActivity.41
        ...
        int i4 = -2;
        SelectAnimatedEmojiDialog.SelectAnimatedEmojiDialogWindow selectAnimatedEmojiDialogWindow = new SelectAnimatedEmojiDialog.SelectAnimatedEmojiDialogWindow(selectAnimatedEmojiDialog, i4, i4) { // from class: org.telegram.ui.DialogsActivity.42
    ...
    private void updateDialogsHint() {
        ...
        if (isPremiumRestoreHintVisible()) {
            ...
            this.dialogsHintCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda31
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateDialogsHint$23() {
    ...
    public void createGroupForThis() {
        ...
        if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeBroadcast) {
            ...
            channelCreateActivity.setOnFinishListener(new Utilities.Callback2() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda77
        ...
        if (tLRPC$RequestPeerType instanceof TLRPC$TL_requestPeerTypeChat) {
            ...
            groupCreateFinalActivity.setDelegate(new AnonymousClass43(alertDialog));
            presentFragment(groupCreateFinalActivity);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$34(final ChannelCreateActivity channelCreateActivity, final AlertDialog alertDialog, final BaseFragment baseFragment, final Long l) {
        Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda81
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$26(l, channelCreateActivity, baseFragment, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda82
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                DialogsActivity.this.lambda$createGroupForThis$28(alertDialog, l, (Runnable) obj);
            }
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda79
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
        ...
        }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda83
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$26(Long l, final ChannelCreateActivity channelCreateActivity, final BaseFragment baseFragment, Runnable runnable) {
        showSendToBotAlert(getMessagesController().getChat(l), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda65
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$25(ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment) {
        removeSelfFromStack();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$28(AlertDialog alertDialog, Long l, final Runnable runnable) {
        ...
        if (bool != null && bool.booleanValue()) {
            getMessagesController().addUserToChat(l.longValue(), getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), 0, null, this, false, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda70
                ...
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$27;
                    lambda$createGroupForThis$27 = DialogsActivity.lambda$createGroupForThis$27(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$27;
                }
            });
        } else {
            runnable.run();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$27(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }
    ...
    public /* synthetic */ void lambda$createGroupForThis$30(Long l, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            ...
            messagesController.setUserAdminRole(longValue, user, tLRPC$TL_chatAdminRights, null, false, this, bool == null || !bool.booleanValue(), true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda71
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$29;
                    lambda$createGroupForThis$29 = DialogsActivity.lambda$createGroupForThis$29(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$29;
                }
            });
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$29(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$32(Long l, final Runnable runnable) {
        if (this.requestPeerType.user_admin_rights != null) {
            getMessagesController().setUserAdminRole(l.longValue(), getAccountInstance().getUserConfig().getCurrentUser(), ChatRightsEditActivity.rightsOR(getMessagesController().getChat(l).admin_rights, this.requestPeerType.user_admin_rights), null, true, this, false, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda72
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$createGroupForThis$31;
                    lambda$createGroupForThis$31 = DialogsActivity.lambda$createGroupForThis$31(runnable, tLRPC$TL_error);
                    return lambda$createGroupForThis$31;
                }
            });
        } else {
            runnable.run();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$createGroupForThis$31(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createGroupForThis$33(AlertDialog alertDialog, Long l, ChannelCreateActivity channelCreateActivity, BaseFragment baseFragment, Runnable runnable) {
        alertDialog.dismiss();
    ...
    /* renamed from: org.telegram.ui.DialogsActivity$43, reason: invalid class name */
    class AnonymousClass43 implements GroupCreateFinalActivity.GroupCreateFinalActivityDelegate {
        ...
        AnonymousClass43(AlertDialog alertDialog) {
        ...
        public void didFinishChatCreation(GroupCreateFinalActivity groupCreateFinalActivity, final long j) {
            ...
            Utilities.doCallbacks(new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda7
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$1(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda8
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$3(j, baseFragmentArr, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda9
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$5(alertDialog, j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda5
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$7(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda6
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$9(j, (Runnable) obj);
                }
            }, new Utilities.Callback() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda10
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$10(alertDialog2, j, baseFragmentArr, (Runnable) obj);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$didFinishChatCreation$1(long j, BaseFragment[] baseFragmentArr, final Runnable runnable) {
            if (DialogsActivity.this.requestPeerType.has_username != null && DialogsActivity.this.requestPeerType.has_username.booleanValue()) {
                ...
                channelCreateActivity.setOnFinishListener(new Utilities.Callback2() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda4
                    @Override // org.telegram.messenger.Utilities.Callback2
                    public final void run(Object obj, Object obj2) {
                        runnable.run();
                    }
        ...
        public /* synthetic */ void lambda$didFinishChatCreation$3(long j, final BaseFragment[] baseFragmentArr, Runnable runnable) {
            DialogsActivity.this.showSendToBotAlert(DialogsActivity.this.getMessagesController().getChat(Long.valueOf(j)), runnable, new Runnable() { // from class: org.telegram.ui.DialogsActivity$43$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DialogsActivity.AnonymousClass43.this.lambda$didFinishChatCreation$2(baseFragmentArr);
                }
            });
        }
    ...
    private void updateAppUpdateViews(boolean z) {
        ...
        if (z2) {
            ...
            if (z) {
                ...
                this.updateLayoutAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.44
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
        ...
        if (z) {
            ...
            this.updateLayoutAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.45
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void updateFiltersView(boolean r11, java.util.ArrayList<java.lang.Object> r12, java.util.ArrayList<org.telegram.ui.Adapters.FiltersView.DateData> r13, boolean r14, boolean r15) {
        /*
            r10 = this;
    ...
    public void updateSpeedItem(boolean z) {
        ...
        if (z3 != (this.speedItem.getTag() != null)) {
            ...
            animatorSet2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.46
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    private void createActionMode(String str) {
        ...
        this.selectedDialogsCountTextView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda39
        ...
        this.muteItem.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda37
        ...
        if (str == null) {
            this.actionBar.setActionBarMenuOnItemClick(new AnonymousClass47());
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$createActionMode$36(View view) {
        performSelectedDialogsAction(this.selectedDialogs, 104, true, true);
        return true;
    }

    /* renamed from: org.telegram.ui.DialogsActivity$47, reason: invalid class name */
    class AnonymousClass47 extends ActionBar.ActionBarMenuOnItemClick {
        AnonymousClass47() {
        }
        ...
        public void onItemClick(int i) {
            ...
            if (i == 1) {
                ...
                ((LaunchActivity) DialogsActivity.this.getParentActivity()).showPasscodeActivity(false, true, iArr[0] + (DialogsActivity.this.passcodeItem.getMeasuredWidth() / 2), iArr[1] + (DialogsActivity.this.passcodeItem.getMeasuredHeight() / 2), new Runnable() { // from class: org.telegram.ui.DialogsActivity$47$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.AnonymousClass47.this.lambda$onItemClick$0();
                    }
                }, new Runnable() { // from class: org.telegram.ui.DialogsActivity$47$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        DialogsActivity.AnonymousClass47.this.lambda$onItemClick$1();
                    }
                });
            ...
            if (i == 109) {
                ...
                filtersListBottomSheet.setDelegate(new FiltersListBottomSheet.FiltersListBottomSheetDelegate() { // from class: org.telegram.ui.DialogsActivity$47$$ExternalSyntheticLambda2
                    ...
                    public final void didSelectFilter(MessagesController.DialogFilter dialogFilter) {
                        DialogsActivity.AnonymousClass47.this.lambda$onItemClick$2(dialogFilter);
                    }
                });
    ...
    public void onResume() {
        ...
        if ((this.afterSignup || getUserConfig().unacceptedTermsOfService == null) && this.checkPermission && !this.onlySelect && (i = Build.VERSION.SDK_INT) >= 23) {
            ...
            if (getParentActivity() == null || MessagesController.getGlobalNotificationsSettings().getBoolean("askedAboutMiuiLockscreen", false)) {
                ...
                showDialog(new AlertDialog.Builder(getParentActivity()).setTopAnimation(R.raw.permission_request_apk, 72, false, Theme.getColor(Theme.key_dialogTopBackground)).setMessage(LocaleController.getString("PermissionXiaomiLockscreen", R.string.PermissionXiaomiLockscreen)).setPositiveButton(LocaleController.getString("PermissionOpenSettings", R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda12
                    ...
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
                        DialogsActivity.lambda$onResume$40(dialogInterface, i3);
                    }
                }).create());
            }
        }
        ...
        Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.DialogsActivity.48
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$38(boolean z, boolean z2, Activity activity) {
        ...
        if (z || z2) {
            ...
            if (z && this.askAboutContacts && getUserConfig().syncContacts && activity.shouldShowRequestPermissionRationale("android.permission.READ_CONTACTS")) {
                AlertDialog create = AlertsCreator.createContactsPermissionDialog(activity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda74
                ...
                if (z2 && activity.shouldShowRequestPermissionRationale("android.permission.WRITE_EXTERNAL_STORAGE")) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onResume$39(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onResume$40(DialogInterface dialogInterface, int i) {
    ...
    public void showSearch(final boolean z, boolean z2, boolean z3) {
        ...
        if (z4) {
            ...
            if (actionBarMenuItem != null) {
                ...
                fArr8[0] = z ? 0.0f : 1.0f;
                arrayList.add(ObjectAnimator.ofFloat(iconView, (Property<RLottieImageView, Float>) property8, fArr8));
            }
            ...
            if (filterTabsView2 != null && filterTabsView2.getVisibility() == 0) {
                ...
                fArr9[0] = z ? 0.0f : 1.0f;
                ObjectAnimator duration = ObjectAnimator.ofFloat(tabsContainer, (Property<RecyclerListView, Float>) property9, fArr9).setDuration(100L);
                this.tabsAlphaAnimator = duration;
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.49
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            ...
            this.searchAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.50
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        ...
        if (i4 >= 0) {
            ...
            searchViewPager5.setPosition(searchViewPager5.getPositionForType(i4));
        }
        if (!z) {
            this.initialSearchType = -1;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSearch$41(ValueAnimator valueAnimator) {
    ...
    private void updateFilterTabsVisibility(boolean z) {
        ...
        if (this.filterTabsViewIsVisible != z3) {
            ...
            if (z) {
                ...
                this.filtersTabAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.51
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateFilterTabsVisibility$42(boolean z, float f, ValueAnimator valueAnimator) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkListLoad$43(boolean z, boolean z2, boolean z3, boolean z4) {
        if (z) {
    ...
    */
            ...
            if (adapter == dialogsSearchAdapter) {
                ...
                if (!this.searchViewPager.dialogsSearchAdapter.isSearchWas()) {
                    ...
                    if (item instanceof TLRPC$Chat) {
                        ...
                        makeEncryptedDialogId = DialogObject.makeEncryptedDialogId(r6.id);
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onItemLongClick$44(long j, DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onArchiveLongPress$45(DialogInterface dialogInterface, int i) {
        if (i == 0) {
    ...
    public boolean showChatPreview(final DialogCell dialogCell) {
        ...
        if (zArr[r1]) {
            ...
            bundle = null;
            actionBarMenuSubItem2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda35
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        actionBarMenuSubItem4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda34
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$46(DialogCell dialogCell, long j, View view) {
        if (dialogCell.getHasUnread()) {
            markAsRead(j);
        } else {
            markAsUnread(j);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$48(final MessagesController.DialogFilter dialogFilter, final TLRPC$Dialog tLRPC$Dialog, final long j, View view) {
        finishPreviewFragment();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$47(MessagesController.DialogFilter dialogFilter, TLRPC$Dialog tLRPC$Dialog, long j) {
        int i;
        boolean z;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$49(long j, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showChatPreview$50(ArrayList arrayList, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideActionMode$52(ValueAnimator valueAnimator) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$53(ArrayList arrayList) {
        getMessagesController().addDialogToFolder(arrayList, this.folderId == 0 ? 0 : 1, -1, null, 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$55(ArrayList arrayList, final int i, DialogInterface dialogInterface, int i2) {
        ...
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(arrayList2, i == 102 ? 27 : 26, (Object) null, (Object) null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda57
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$54(int i, ArrayList arrayList) {
        if (i == 102) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$56(ArrayList arrayList, boolean z, boolean z2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$57(DialogInterface dialogInterface, int i) {
        getMessagesController().hidePromoDialog();
        hideActionMode(false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$59(final int i, final TLRPC$Chat tLRPC$Chat, final long j, final boolean z, final boolean z2) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        if (undoView != null) {
            i3 = i2;
            undoView.showWithAction(j, i == 103 ? 0 : 1, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda56
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$60(DialogInterface dialogInterface) {
        hideActionMode(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$performSelectedDialogsAction$61(DialogInterface dialogInterface) {
        hideActionMode(true);
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$pinDialog$62() {
        setDialogsListFrozen(false);
    }
    ...
    public void updateCounters(boolean z) {
        ...
        while (true) {
            ...
            TLRPC$Dialog tLRPC$Dialog = getMessagesController().dialogs_dict.get(this.selectedDialogs.get(i).longValue());
            if (tLRPC$Dialog != null) {
                ...
                if (this.folderId == 1 || tLRPC$Dialog.folder_id == 1) {
                    this.canUnarchiveCount++;
                } else if (j != clientUserId && j != 777000) {
        ...
        FilterTabsView filterTabsView2 = this.filterTabsView;
        boolean z3 = filterTabsView2 == null || filterTabsView2.getVisibility() != 0 || this.filterTabsView.currentTabIsDefault();
        if (!z3) {
            try {
        ...
        FilterTabsView filterTabsView3 = this.filterTabsView;
        if (filterTabsView3 != null && filterTabsView3.getVisibility() == 0 && this.filterTabsView.currentTabIsDefault() && !FiltersListBottomSheet.getCanAddDialogFilters(this, this.selectedDialogs).isEmpty()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showOrUpdateActionMode$63(ValueAnimator valueAnimator) {
        this.progressToActionMode = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        for (int i = 0; i < this.actionBar.getChildCount(); i++) {
            if (this.actionBar.getChildAt(i).getVisibility() == 0 && this.actionBar.getChildAt(i) != this.actionBar.getActionMode() && this.actionBar.getChildAt(i) != this.actionBar.getBackButton()) {
                this.actionBar.getChildAt(i).setAlpha(1.0f - this.progressToActionMode);
    ...
    public void createUndoView() {
        ...
        if (this.undoView[0] == null && (context = getContext()) != null) {
            for (int i = 0; i < 2; i++) {
                this.undoView[i] = new AnonymousClass52(context);
                ContentView contentView = (ContentView) this.fragmentView;
    ...
    /* renamed from: org.telegram.ui.DialogsActivity$52, reason: invalid class name */
    class AnonymousClass52 extends UndoView {
            ...
            if (i == 1 || i == 27) {
                ...
                if (DialogsActivity.this.frozenDialogsList != null) {
                    ...
                    if (i2 >= 0) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.DialogsActivity$52$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                DialogsActivity.AnonymousClass52.this.lambda$onRemoveDialogAction$0(i2, tLRPC$Dialog);
                            }
                        });
                    } else {
                        DialogsActivity.this.setDialogsListFrozen(false);
    ...
    public void showDoneItem(final boolean z) {
        ...
        if (z) {
            ...
            ActionBarMenuItem actionBarMenuItem3 = this.downloadsItem;
            if (actionBarMenuItem3 != null && this.downloadsItemVisible) {
        ...
        this.doneItemAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.53
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
        ...
        if (this.commentView != null) {
            if (this.selectedDialogs.isEmpty()) {
                if (this.initialDialogsType == 3 && this.selectAlertString == null) {
                    TextView textView = tvTitle;
                    if (textView != null) {
                        textView.setText(LocaleController.getString("ForwardTo", R.string.ForwardTo));
                    }
                } else {
                    TextView textView2 = tvTitle;
                    if (textView2 != null) {
                        textView2.setText(LocaleController.getString("SelectChat", R.string.SelectChat));
                    }
                }
                if (this.commentView.getTag() != null) {
                    ...
                    this.commentViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.54
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                ...
                if (this.commentView.getTag() == null) {
                    ...
                    this.commentViewAnimator.setDuration(180L);
                    this.commentViewAnimator.setInterpolator(new DecelerateInterpolator());
                    this.commentViewAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.55
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
                ...
                if (textView3 != null) {
                    textView3.setText(LocaleController.formatPluralString("Recipient", this.selectedDialogs.size(), new Object[0]));
                }
            }
    ...
    public void askForPermissons(boolean z) {
        ...
        if (getUserConfig().syncContacts && this.askAboutContacts && parentActivity.checkSelfPermission("android.permission.READ_CONTACTS") != 0) {
            if (z) {
                final AlertDialog.Builder createContactsPermissionDialog = AlertsCreator.createContactsPermissionDialog(parentActivity, new MessagesStorage.IntCallback() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda75
                    @Override // org.telegram.messenger.MessagesStorage.IntCallback
                    public final void run(int i) {
                        DialogsActivity.this.lambda$askForPermissons$64(i);
                    }
                });
                new Handler().postDelayed(new Runnable() { // from class: org.telegram.ui.DialogsActivity.56
                    @Override // java.lang.Runnable
                    public void run() {
                        if (BuildVars.isRequestContacts) {
                            if (!BuildVars.isRequestContactsPrompt) {
                                DialogsActivity.this.askForPermissons(false);
                            } else {
                                DialogsActivity dialogsActivity = DialogsActivity.this;
                                dialogsActivity.showDialog(dialogsActivity.permissionDialog = createContactsPermissionDialog.create());
                            }
                        }
                    }
                }, 1000L);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$askForPermissons$64(int i) {
        this.askAboutContacts = i != 0;
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.DialogsActivity.57
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onRequestPermissionsResultFragment$65() {
    ...
    public void didReceivedNotification(int i, int i2, final Object... objArr) {
        ...
        if (i == NotificationCenter.contactsDidLoad) {
            ...
            while (true) {
                ...
                if (!viewPageArr3[i8].isDefaultDialogType() || getMessagesController().getAllFoldersDialogsCount() > 10) {
                    z4 = true;
                } else {
        ...
        if (i == NotificationCenter.openedChatChanged) {
            ...
            while (true) {
                ...
                if (i9 < viewPageArr4.length) {
                    if (viewPageArr4[i9].isDefaultDialogType() && AndroidUtilities.isTablet()) {
            ...
            if (i == NotificationCenter.needDeleteDialog) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda63
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (i == NotificationCenter.onDatabaseMigration) {
                ...
                if (this.fragmentView != null) {
                    ...
                    view2.animate().setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.58
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animator) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$66(ViewPage viewPage, Object[] objArr) {
        reloadViewPageDialogs(viewPage, objArr.length > 0);
        FilterTabsView filterTabsView = this.filterTabsView;
        if (filterTabsView == null || filterTabsView.getVisibility() != 0) {
            return;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didReceivedNotification$67(TLRPC$Chat tLRPC$Chat, long j, boolean z, TLRPC$User tLRPC$User, boolean z2) {
        if (tLRPC$Chat != null) {
            if (ChatObject.isNotInChat(tLRPC$Chat)) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$68(DialogInterface dialogInterface, int i) {
        presentFragment(new PrivacySettingsActivity());
        AndroidUtilities.scrollToFragmentRow(this.parentLayout, "newChatsRow");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showSuggestion$69(DialogInterface dialogInterface) {
        onSuggestionDismiss();
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFiltersHint$71() {
        UndoView undoView = getUndoView();
        if (undoView != null) {
            undoView.showWithAction(0L, 15, null, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda49
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showFiltersHint$70() {
    ...
    private void setDialogsListFrozen(boolean z, boolean z2) {
        ...
        if (this.viewPages[0].listView.isComputingLayout()) {
            this.viewPages[0].listView.post(new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda45
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setDialogsListFrozen$72() {
        this.viewPages[0].dialogsAdapter.notifyDataSetChanged();
    }
    ...
    */
    ...
    private void setFloatingProgressVisible(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            animatorSet2.playTogether(animatorArr);
            this.floatingProgressAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogsActivity.59
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideFloatingButton$73(ValueAnimator valueAnimator) {
    ...
    public void animateContactsAlpha(float f) {
        ...
        this.contactsAlphaAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateContactsAlpha$74(ValueAnimator valueAnimator) {
    ...
    */
    ...
    public void didSelectResult(final long j, final int i, boolean z, final boolean z2, final TopicsFragment topicsFragment) {
        ...
        if (checkCanWrite(j)) {
            ...
            if (i2 == 11 || i2 == 12 || i2 == 13) {
                ...
                getConnectionsManager().sendRequest(tLRPC$TL_messages_checkHistoryImportPeer, new RequestDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda84
                    @Override // org.telegram.tgnet.RequestDelegate
            ...
            if (!z || ((this.selectAlertString == null || this.selectAlertStringGroup == null) && this.addToGroupAlertString == null)) {
                if (i2 == 15) {
                    final Runnable runnable = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda58
                        @Override // java.lang.Runnable
                        public final void run() {
                            DialogsActivity.this.lambda$didSelectResult$79(j, i, z2, topicsFragment);
                        }
                    };
                    Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda59
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$76(AlertDialog alertDialog, TLObject tLObject, TLRPC$User tLRPC$User, TLRPC$Chat tLRPC$Chat, final long j, final boolean z, TLRPC$TL_error tLRPC$TL_error, TLRPC$TL_messages_checkHistoryImportPeer tLRPC$TL_messages_checkHistoryImportPeer) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.e(e);
        ...
        if (tLObject != null) {
            AlertsCreator.createImportDialogAlert(this, this.arguments.getString("importTitle"), ((TLRPC$TL_messages_checkedHistoryImportPeer) tLObject).confirm_text, tLRPC$User, tLRPC$Chat, new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda60
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$75(long j, boolean z) {
        setDialogsListFrozen(true);
        ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
        arrayList.add(MessagesStorage.TopicKey.of(j, 0));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$78(long j, int i, TopicsFragment topicsFragment, DialogInterface dialogInterface, int i2) {
        didSelectResult(j, i, false, false, topicsFragment);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$79(long j, int i, boolean z, TopicsFragment topicsFragment) {
        if (this.delegate != null) {
            ArrayList<MessagesStorage.TopicKey> arrayList = new ArrayList<>();
            arrayList.add(MessagesStorage.TopicKey.of(j, i));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$didSelectResult$81(long j, final Runnable runnable) {
        if (this.requestPeerType.bot_admin_rights != null) {
            getMessagesController().setUserAdminRole(-j, getMessagesController().getUser(Long.valueOf(this.requestPeerBotId)), this.requestPeerType.bot_admin_rights, null, false, this, true, true, null, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda69
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC$TL_error tLRPC$TL_error) {
                    boolean lambda$didSelectResult$80;
                    lambda$didSelectResult$80 = DialogsActivity.lambda$didSelectResult$80(runnable, tLRPC$TL_error);
                    return lambda$didSelectResult$80;
                }
            });
        } else {
            runnable.run();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ boolean lambda$didSelectResult$80(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        runnable.run();
        return true;
    }
    ...
    private void showSendToBotAlert(TLRPC$User tLRPC$User, final Runnable runnable, final Runnable runnable2) {
        ...
        }).setNegativeButton(LocaleController.formatString("Cancel", R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda7
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showSendToBotAlert$83(Runnable runnable, DialogInterface dialogInterface, int i) {
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public void showSendToBotAlert(TLRPC$Chat tLRPC$Chat, final Runnable runnable, final Runnable runnable2) {
        ...
        showDialog(title.setMessage(TextUtils.concat(charSequenceArr)).setPositiveButton(LocaleController.formatString("Send", R.string.Send, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda9
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.formatString("Cancel", R.string.Cancel, new Object[0]), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda8
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$showSendToBotAlert$85(Runnable runnable, DialogInterface dialogInterface, int i) {
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    private boolean onSendLongClick(View view) {
        ...
        actionBarPopupWindowLayout.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.DialogsActivity.60
        ...
        actionBarPopupWindowLayout.setDispatchKeyEventListener(new ActionBarPopupWindow.OnDispatchKeyEventListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda85
        ...
        actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda25
            @Override // android.view.View.OnClickListener
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$86(KeyEvent keyEvent) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSendLongClick$87(View view) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x0825 A[SYNTHETIC] */
    @Override // org.telegram.ui.ActionBar.BaseFragment
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    ...
    */
    ...
    public List<FloatingDebugController.DebugItem> onGetDebugItems() {
        return Arrays.asList(new FloatingDebugController.DebugItem(LocaleController.getString(R.string.DebugDialogsActivity)), new FloatingDebugController.DebugItem(LocaleController.getString(R.string.ClearLocalDatabase), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda53
            @Override // java.lang.Runnable
            public final void run() {
                DialogsActivity.this.lambda$onGetDebugItems$92();
            }
        }), new FloatingDebugController.DebugItem(LocaleController.getString(R.string.DebugClearSendMessageAsPeers), new Runnable() { // from class: org.telegram.ui.DialogsActivity$$ExternalSyntheticLambda47
            @Override // java.lang.Runnable
            public final void run() {
