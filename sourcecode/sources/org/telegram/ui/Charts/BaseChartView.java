...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    void drawBottomSignature(Canvas canvas) {
        ...
        while (true) {
            ...
            for (int i9 = i5 + i7; i9 < i8; i9 += i4) {
                if (i9 >= 0) {
                    if (i9 < this.chartData.x.length - 1) {
                        float f3 = (((r10[i9] - r10[0]) / (r10[r10.length - 1] - r10[0])) * this.chartFullWidth) - f2;
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r11, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData r12) {
        /*
            r10 = this;
            int[] r0 = r12.values
            int r1 = r0.length
    ...
    */
    ...
    public void moveLegend(float f) {
        ...
        this.legendSignatureView.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), LinearLayoutManager.INVALID_OFFSET), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), LinearLayoutManager.INVALID_OFFSET));
