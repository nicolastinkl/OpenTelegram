    ...
    public View createView(Context context) {
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.telegram.ui.CameraScanActivity.3
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                ...
                int i8 = i4 + lerp2;
                CameraScanActivity.this.path.arcTo(aroundPoint(i3, i8, i7), 0.0f, 180.0f);
                float f5 = lerp * 1.5f;
                int i9 = (int) (f3 + f5);
                int i10 = (int) (f + f5);
                int i11 = lerp * 2;
                CameraScanActivity.this.path.arcTo(aroundPoint(i9, i10, i11), 180.0f, 90.0f);
                int i12 = i3 + lerp2;
                CameraScanActivity.this.path.arcTo(aroundPoint(i12, i4, i7), 270.0f, 180.0f);
                CameraScanActivity.this.path.lineTo(i3 + i7, i4 + i7);
                CameraScanActivity.this.path.arcTo(aroundPoint(i9, i10, lerp), 270.0f, -90.0f);
                CameraScanActivity.this.path.close();
                canvas.drawPath(CameraScanActivity.this.path, CameraScanActivity.this.cornerPaint);
                CameraScanActivity.this.path.reset();
                CameraScanActivity.this.path.arcTo(aroundPoint(i6, i8, i7), 180.0f, -180.0f);
                int i13 = (int) (f4 - f5);
                CameraScanActivity.this.path.arcTo(aroundPoint(i13, i10, i11), 0.0f, -90.0f);
                int i14 = i6 - lerp2;
                CameraScanActivity.this.path.arcTo(aroundPoint(i14, i4, i7), 270.0f, -180.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i13, i10, lerp), 270.0f, 90.0f);
                CameraScanActivity.this.path.close();
                canvas.drawPath(CameraScanActivity.this.path, CameraScanActivity.this.cornerPaint);
                CameraScanActivity.this.path.reset();
                int i15 = i5 - lerp2;
                CameraScanActivity.this.path.arcTo(aroundPoint(i3, i15, i7), 0.0f, -180.0f);
                int i16 = (int) (f2 - f5);
                CameraScanActivity.this.path.arcTo(aroundPoint(i9, i16, i11), 180.0f, -90.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i12, i5, i7), 90.0f, -180.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i9, i16, lerp), 90.0f, 90.0f);
                CameraScanActivity.this.path.close();
                canvas.drawPath(CameraScanActivity.this.path, CameraScanActivity.this.cornerPaint);
                CameraScanActivity.this.path.reset();
                CameraScanActivity.this.path.arcTo(aroundPoint(i6, i15, i7), 180.0f, 180.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i13, i16, i11), 0.0f, 90.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i14, i5, i7), 90.0f, 180.0f);
                CameraScanActivity.this.path.arcTo(aroundPoint(i13, i16, lerp), 90.0f, -90.0f);
                CameraScanActivity.this.path.close();
                canvas.drawPath(CameraScanActivity.this.path, CameraScanActivity.this.cornerPaint);
                return drawChild;
            }
