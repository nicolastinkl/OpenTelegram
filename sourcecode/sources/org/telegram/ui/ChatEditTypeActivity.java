    ...
    */
    ...
    class UsernamesListView extends RecyclerListView {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(9999999, LinearLayoutManager.INVALID_OFFSET));
        }
    ...
    private boolean trySetUsername() {
        ...
        getMessagesController().updateChannelUserName(this, this.chatId, obj, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$18(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ChatEditTypeActivity.this.lambda$loadAdminedChannels$17(currentChannel, dialogInterface, i);
            }
        });
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            ...
            if (this.loadingAdminedChannels) {
                ...
                shadowSectionCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, i4, i5));
                TextInfoPrivacyCell textInfoPrivacyCell2 = this.typeInfoCell;
                textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell2.getContext(), R.drawable.greydivider_top, i5));
            ...
            textInfoPrivacyCell4.setBackgroundDrawable(Theme.getThemedDrawableByKey(context2, i7, i8));
            this.adminnedChannelsLayout.setVisibility(8);
            this.linkContainer.setVisibility(8);
            this.loadingAdminedCell.setVisibility(8);
            if (this.isChannel) {
            ...
            this.typeInfoCell.setVisibility(8);
            this.manageLinksInfoCell.setVisibility(8);
            ...
            if (this.isPrivate) {
                ...
                textInfoPrivacyCell8.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell8.getContext(), R.drawable.greydivider, i8));
                this.manageLinksInfoCell.setBackground(Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), i7, i8));
            } else {
                this.typeInfoCell.setBackgroundDrawable(this.checkTextView.getVisibility() != 0 ? Theme.getThemedDrawableByKey(this.typeInfoCell.getContext(), i7, i8) : null);
            }
        }
        ...
        if (usernamesListView != null) {
            usernamesListView.setVisibility((this.isPrivate || this.usernames.isEmpty()) ? 8 : 0);
        }
        checkDoneButton();
    }
