...
public class GroupCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (childAt instanceof GroupCreateSpan) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(size, LinearLayoutManager.INVALID_OFFSET), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(32.0f), 1073741824));
    ...
    public View createView(Context context) {
        ...
        ViewGroup viewGroup = new ViewGroup(context) { // from class: org.telegram.ui.GroupCreateActivity.2
            ...
            protected void onMeasure(int i5, int i6) {
                ...
                GroupCreateActivity.this.scrollView.measure(View.MeasureSpec.makeMeasureSpec(size, 1073741824), View.MeasureSpec.makeMeasureSpec(GroupCreateActivity.this.maxSize, LinearLayoutManager.INVALID_OFFSET));
        ...
        this.editText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda4
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i5, KeyEvent keyEvent) {
                boolean lambda$createView$0;
                lambda$createView$0 = GroupCreateActivity.this.lambda$createView$0(textView, i5, keyEvent);
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda6
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i5) {
                GroupCreateActivity.this.lambda$createView$2(view, i5);
            }
        });
        ...
        if (this.isNeverShare || this.isAlwaysShare || this.addToGroup) {
            ...
            backDrawable.setArrowRotation(SubsamplingScaleImageView.ORIENTATION_180);
        ...
        this.floatingButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                GroupCreateActivity.this.lambda$createView$3(view);
            }
        });
                                ...
                                if (ChatObject.canAddAdmins(chat)) {
                                    ...
                                    builder2.setPositiveButton(LocaleController.getString("AddAsAdmin", R.string.AddAsAdmin), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda0
                                        ...
                                        public final void onClick(DialogInterface dialogInterface, int i2) {
                                            GroupCreateActivity.this.lambda$createView$1(tLRPC$User, dialogInterface, i2);
                                        }
                                    });
    ...
    public boolean onDonePressed(boolean z) {
        ...
        if (z && this.addToGroup) {
            ...
            if (!ChatObject.isChannel(chat)) {
                ...
                checkBoxCellArr[0].setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda3
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        GroupCreateActivity.lambda$onDonePressed$4(checkBoxCellArr, view);
                    }
                });
            ...
            builder.setPositiveButton(LocaleController.getString("Add", R.string.Add), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda1
                ...
                public final void onClick(DialogInterface dialogInterface, int i3) {
                    GroupCreateActivity.this.lambda$onDonePressed$5(checkBoxCellArr, dialogInterface, i3);
                }
            });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$onDonePressed$4(CheckBoxCell[] checkBoxCellArr, View view) {
        checkBoxCellArr[0].setChecked(!checkBoxCellArr[0].isChecked(), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onDonePressed$5(CheckBoxCell[] checkBoxCellArr, DialogInterface dialogInterface, int i) {
        int i2 = 0;
    ...
    public class GroupCreateAdapter extends RecyclerListView.FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context context) {
            ...
            ConnectionsManager.getInstance(((BaseFragment) GroupCreateActivity.this).currentAccount).sendRequest(new TLRPC$JMT_friendList_req(), new RequestDelegate(GroupCreateActivity.this) { // from class: org.telegram.ui.GroupCreateActivity.GroupCreateAdapter.1
                @Override // org.telegram.tgnet.RequestDelegate
                public void run(final TLObject tLObject, final TLRPC$TL_error tLRPC$TL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.GroupCreateActivity.GroupCreateAdapter.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            if (tLRPC$TL_error == null) {
                                TLObject tLObject2 = tLObject;
                                if (tLObject2 instanceof TLRPC$Vector) {
                                    GroupCreateAdapter.this.contacts.clear();
                                    Iterator<Object> it = ((TLRPC$Vector) tLObject2).objects.iterator();
                                    while (it.hasNext()) {
                                        Object next = it.next();
                                        if (next instanceof TLRPC$JMT_friendList_res) {
                                            GroupCreateAdapter.this.contacts.add(((TLRPC$JMT_friendList_res) next).user);
                                        }
                                    }
            ...
            searchAdapterHelper.setDelegate(new SearchAdapterHelper.SearchAdapterHelperDelegate() { // from class: org.telegram.ui.GroupCreateActivity$GroupCreateAdapter$$ExternalSyntheticLambda4
                ...
                public final void onDataSetChanged(int i) {
                    GroupCreateActivity.GroupCreateAdapter.this.lambda$new$0(i);
                }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                if (i == 1) {
                    ...
                    StickerEmptyView stickerEmptyView = new StickerEmptyView(this, this.context, null, i2) { // from class: org.telegram.ui.GroupCreateActivity.GroupCreateAdapter.2
        ...
        public int getItemViewType(int i) {
            return this.searching ? i == this.searchResult.size() + this.searchAdapterHelper.getLocalServerSearch().size() ? 0 : 1 : this.noContactsStubRow == i ? 3 : 1;
        }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.GroupCreateActivity$$ExternalSyntheticLambda5
            ...
            public final void didSetColor() {
                GroupCreateActivity.this.lambda$getThemeDescriptions$6();
            }
