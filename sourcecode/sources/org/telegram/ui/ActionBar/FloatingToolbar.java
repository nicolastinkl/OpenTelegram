    ...
    final class FloatingToolbarPopup {
        ...
        public void setPanelsStatesAtRestingPosition() {
            ...
            if (this.mIsOverflowOpen) {
                ...
                this.mOverflowButton.setContentDescription(LocaleController.getString("AccDescrMoreOptions", org.telegram.messenger.R.string.AccDescrMoreOptions));
                if (isInRTLMode()) {
        ...
        public List<MenuItem> layoutMainPanelItems(List<MenuItem> list, int i) {
            ...
            while (!linkedList.isEmpty()) {
                ...
                createMenuItemButton.setPaddingRelative((int) ((z ? 1.5d : 1.0d) * createMenuItemButton.getPaddingStart()), createMenuItemButton.getPaddingTop(), (int) ((z2 ? 1.5d : 1.0d) * createMenuItemButton.getPaddingEnd()), createMenuItemButton.getPaddingBottom());
