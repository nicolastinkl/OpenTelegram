...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        */
        ...
        public /* synthetic */ void lambda$run$1(TLRPC$TL_messages_searchStickerSets tLRPC$TL_messages_searchStickerSets, TLObject tLObject) {
            if (tLRPC$TL_messages_searchStickerSets.f38q.equals(StickersSearchAdapter.this.searchQuery)) {
                clear();
    ...
    /* JADX WARN: Type inference failed for: r7v10, types: [android.view.View, android.widget.LinearLayout] */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        boolean z = false;
        if (i == 0) {
            StickerEmojiCell stickerEmojiCell = new StickerEmojiCell(this, this.context, z) { // from class: org.telegram.ui.Adapters.StickersSearchAdapter.2
