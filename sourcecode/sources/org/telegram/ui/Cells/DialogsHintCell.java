...
public class DialogsHintCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.contentView.measure(View.MeasureSpec.makeMeasureSpec((size - getPaddingLeft()) - getPaddingRight(), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, LinearLayoutManager.INVALID_OFFSET));
