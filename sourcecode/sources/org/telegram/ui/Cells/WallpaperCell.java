...
public class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            String str = SubsamplingScaleImageView.ORIENTATION_180 + "_" + SubsamplingScaleImageView.ORIENTATION_180;
            ...
            if (obj instanceof TLRPC$TL_wallPaper) {
                ...
                TLRPC$PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tLRPC$TL_wallPaper.document.thumbs, AndroidUtilities.dp(SubsamplingScaleImageView.ORIENTATION_180));
            ...
            if (obj instanceof WallpapersListActivity.ColorWallpaper) {
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || d.a.equals(colorWallpaper.slug)) {
                    ...
                    if (d.a.equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(R.raw.default_pattern, 100, SubsamplingScaleImageView.ORIENTATION_180, -16777216);
                        }
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (tLRPC$Photo != null) {
                    ...
                    TLRPC$PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.dp(SubsamplingScaleImageView.ORIENTATION_180));
