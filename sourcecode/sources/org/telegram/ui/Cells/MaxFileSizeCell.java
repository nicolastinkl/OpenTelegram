...
public class MaxFileSizeCell extends FrameLayout {
            ...
            public void onSeekBarDrag(boolean z, float f) {
                ...
                if (f <= 0.25f) {
                    ...
                    if (f < 0.25f) {
                        ...
                        f -= 0.25f;
                        if (f > 0.25f) {
                            i = (int) (AbstractJceStruct.JCE_MAX_STRING_LENGTH + ((FileLoader.DEFAULT_MAX_FILE_SIZE - AbstractJceStruct.JCE_MAX_STRING_LENGTH) * ((f - 0.25f) / 0.25f)));
                            long j = i;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.sizeTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, LinearLayoutManager.INVALID_OFFSET), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), 1073741824));
    ...
    public void setSize(long j) {
        ...
        long j2 = j - 512000;
        if (j2 < 536576) {
            f = Math.max(0.0f, j2 / 536576.0f) * 0.25f;
        } else {
            long j3 = j2 - 536576;
            if (j3 < 9437184) {
                f = (Math.max(0.0f, j3 / 9437184.0f) * 0.25f) + 0.25f;
            } else {
                float f2 = 0.5f;
                long j4 = j3 - 9437184;
                if (j4 < 94371840) {
                    max = Math.max(0.0f, j4 / 9.437184E7f);
                } else {
                    f2 = 0.75f;
                    max = Math.max(0.0f, (j4 - 94371840) / 1.9922944E9f);
                }
                f = (max * 0.25f) + f2;
            }
        }
