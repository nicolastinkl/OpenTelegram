...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private JMTSelectUserDelegate selectUserDelegate;
    ...
    public interface JMTSelectUserDelegate {
        void didSelectUser(TLRPC$User tLRPC$User);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:81:0x014b, code lost:
        ...
        if (org.telegram.messenger.ChatObject.canBlockUsers(r0) != false) goto L37;
     */
    ...
    */
    ...
    public View createView(Context context) {
        ...
        if (this.selectType != 0 || (i = this.type) == 2 || i == 4 || i == 0 || i == 3) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:326:0x0751 A[RETURN] */
    ...
    */
    ...
    public boolean createMenuForParticipant(final TLObject tLObject, boolean z, View view) {
        ...
        if (i5 == 2 || i5 == 4) {
            ...
            boolean z8 = z3 || (ChatObject.canBlockUsers(this.currentChat) && z5);
            if (z || !z8) {
                return z8;
            }
            boolean z9 = z3;
            ...
            ItemOptions addIf = ItemOptions.makeOptions(this, view).setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite))).addIf(z9, R.drawable.msg_admins, z6 ? LocaleController.getString("EditAdminRights", R.string.EditAdminRights) : LocaleController.getString("SetAsAdmin", R.string.SetAsAdmin), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
            ...
            addIf.addIf(z12, i6, LocaleController.getString(str2, i2), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
            ...
            if (this.type == 3 && ChatObject.canBlockUsers(this.currentChat)) {
                ...
                makeOptions.add(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatUsersActivity.this.lambda$createMenuForParticipant$15(j);
                    }
                });
                ...
                if (ChatObject.canAddUsers(this.currentChat) && j > 0) {
                    ...
                    makeOptions.add(i7, LocaleController.getString(str3, i3), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatUsersActivity.this.lambda$createMenuForParticipant$16(j);
                        }
                    });
                }
                makeOptions.add(R.drawable.msg_delete, LocaleController.getString("ChannelDeleteFromList", R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatUsersActivity.this.lambda$createMenuForParticipant$17(j);
                    }
                });
                ...
                if (this.currentChat.creator || !(tLObject instanceof TLRPC$TL_channelParticipantCreator)) {
                    ...
                    makeOptions.add(R.drawable.msg_admins, LocaleController.getString("EditAdminRights", R.string.EditAdminRights), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda11
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatUsersActivity.this.lambda$createMenuForParticipant$18(j6, tLRPC$TL_chatAdminRights3, str5, tLObject);
                        }
                    });
                }
                makeOptions.add(R.drawable.msg_remove, LocaleController.getString("ChannelRemoveUserAdmin", R.string.ChannelRemoveUserAdmin), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        ChatUsersActivity.this.lambda$createMenuForParticipant$19(j);
                    }
                });
            }
    ...
    public void setJMTSelectUserDelegate(JMTSelectUserDelegate jMTSelectUserDelegate) {
        this.selectUserDelegate = jMTSelectUserDelegate;
    }
    ...
    private ArrayList<TLRPC$TL_channels_getParticipants> loadChatParticipantsRequests(int i, int i2, boolean z) {
        ...
        tLRPC$TL_channels_getParticipants.filter.f30q = "";
            ...
            if (tLRPC$TL_channels_getParticipants != null && tLRPC$TL_channels_channelParticipants != null) {
                ...
                if (this.selectType != 0) {
                    ...
                    while (true) {
                        ...
                        if (MessageObject.getPeerId(tLRPC$TL_channels_channelParticipants.participants.get(i4).peer) == clientUserId) {
                ...
                if (i8 == 2 || i8 == 4) {
                    ...
                    int i9 = 0;
                    while (i9 < size3) {
                        TLObject tLObject = this.participants.get(i9);
                        if (!(tLObject instanceof TLRPC$ChannelParticipant)) {
                ...
                if ((i == 0 || i == 3 || i == 2 || i == 4) && (tLRPC$Chat = this.currentChat) != null && tLRPC$Chat.megagroup) {
                    TLRPC$ChatFull tLRPC$ChatFull = this.info;
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:387:0x0939, code lost:
            ...
            if (r22.this$0.currentChat.megagroup == false) goto L350;
         */
        /* JADX WARN: Code restructure failed: missing block: B:388:0x093b, code lost:
        
            r8 = true;
         */
        /* JADX WARN: Code restructure failed: missing block: B:465:0x0967, code lost:
        
            if (r22.this$0.currentChat.megagroup == false) goto L350;
         */
        /* JADX WARN: Removed duplicated region for block: B:424:0x0a7d  */
        /* JADX WARN: Removed duplicated region for block: B:427:0x0a80  */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
