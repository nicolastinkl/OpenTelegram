                ...
                if (fArr[i2] != 0.0f) {
                    ...
                    if (clearViewDataArr[i2].firstDraw) {
                        ...
                        if (Math.abs((float) (f10 * ((3.141592653589793d * width) / 180.0d))) <= 1.0f) {
                            ...
                            float centerX = this.rectF.centerX() + ((float) (Math.cos(Math.toRadians(d2)) * width));
                            float centerY = this.rectF.centerY() + ((float) (width * Math.sin(Math.toRadians(d2))));
                ...
                if (fArr2[i3] != 0.0f) {
                    ...
                    if (!clearViewDataArr2[i3].firstDraw) {
                        ...
                        if (Math.abs((float) (f14 * ((width2 * 3.141592653589793d) / d))) <= 1.0f) {
                            ...
                            float centerX2 = this.rectF.centerX() + ((float) (Math.cos(Math.toRadians(d3)) * width2));
                            float centerY2 = this.rectF.centerY() + ((float) (width2 * Math.sin(Math.toRadians(d3))));
                            if (Build.VERSION.SDK_INT >= 21) {
        ...
        for (int i2 = 0; i2 < clearViewDataArr.length; i2++) {
            ...
            if (clearViewDataArr[i2] == null || (!clearViewDataArr[i2].clear && selectedFilesSize2 <= 0)) {
                ...
                if (selectedFilesSize2 <= 0) {
                    selectedFilesSize2 = clearViewDataArr[i2].size;
                }
