...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private class ThemeDrawable {
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (themeSmallPreviewView3.currentType != 2) {
            ...
            if (ThemeSmallPreviewView.this.chatThemeItem.icon != null) {
                canvas.drawBitmap(ThemeSmallPreviewView.this.chatThemeItem.icon, (r14.getWidth() - ThemeSmallPreviewView.this.chatThemeItem.icon.getWidth()) * 0.5f, AndroidUtilities.dp(21.0f), (Paint) null);
            }
        }
    }
