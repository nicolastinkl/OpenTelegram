    ...
    class PreviewGroupsView extends ViewGroup {
        ...
        public int measurePureHeight() {
            ...
            if (this.hintView.getMeasuredHeight() <= 0) {
                this.hintView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x, 1073741824), View.MeasureSpec.makeMeasureSpec(9999, LinearLayoutManager.INVALID_OFFSET));
            }
        ...
        protected void onMeasure(int i, int i2) {
            this.hintView.measure(i, View.MeasureSpec.makeMeasureSpec(9999, LinearLayoutManager.INVALID_OFFSET));
        ...
        */
        ...
        class PreviewGroupCell {
            ...
            public void setGroup(GroupCalculator groupCalculator, boolean z) {
                ...
                long elapsedRealtime = SystemClock.elapsedRealtime();
                if (elapsedRealtime - this.lastMediaUpdate < 200) {
                    float f = (elapsedRealtime - r5) / 200.0f;
