    ...
    public void onDraw(View view, Canvas canvas) {
        ...
        if (Utilities.random.nextBoolean() && this.particles.size() + 8 < 150) {
            ...
            for (int i4 = 0; i4 < 8; i4++) {
                double nextInt2 = (Utilities.random.nextInt(SubsamplingScaleImageView.ORIENTATION_270) - 225) * 0.017453292519943295d;
                float cos2 = (float) Math.cos(nextInt2);
