    ...
    */
    ...
    private void onJoinButtonClicked() {
        ...
        if (button == null || !button.isLoading()) {
            ...
            if (this.selectedPeers.isEmpty() && (this.invite instanceof TLRPC$TL_chatlists_chatlistInvite)) {
            ...
            if (this.deleting) {
                ...
                if ((this.invite instanceof TLRPC$TL_chatlists_chatlistInviteAlready) && arrayList2.isEmpty()) {
                    dismiss();
                    return;
                }
        ...
        return new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.FolderBottomSheet.1
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == 0) {
                    ...
                    view = folderBottomSheet.titleCell = folderBottomSheet2.new TitleCell(folderBottomSheet2.getContext(), (FolderBottomSheet.this.invite instanceof TLRPC$TL_chatlists_chatlistInviteAlready) || FolderBottomSheet.this.updates != null, FolderBottomSheet.this.escapedTitle);
                } else if (i == 1) {
