        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (customEmojiReactionsWindow.isShowing) {
                ...
                if (CustomEmojiReactionsWindow.this.reactionsContainerLayout != null) {
                    ...
                    canvas.clipRect((int) (CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getY() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getY()), x + (AndroidUtilities.dp(36.0f) * CustomEmojiReactionsWindow.this.enterTransitionProgress), r2 + r6.selectAnimatedEmojiDialog.emojiGridView.getMeasuredHeight(), x + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getMeasuredWidth());
                    int i6 = -1;
                    int i7 = -1;
                    f6 = 0.0f;
                    float f18 = 0.0f;
                    ...
                    while (i7 < CustomEmojiReactionsWindow.this.reactionsContainerLayout.recyclerListView.getChildCount()) {
                        ...
                        if (customEmojiReactionsWindow6.enterTransitionProgress != f16 || i7 != i6) {
                            if (i7 == i6) {
                                childAt = customEmojiReactionsWindow6.reactionsContainerLayout.nextRecentReaction;
                            } else {
                                childAt = customEmojiReactionsWindow6.reactionsContainerLayout.recyclerListView.getChildAt(i7);
                            }
                            View view = childAt;
                            if (view.getLeft() >= 0 && view.getVisibility() != 8) {
                                ...
                                if (view instanceof ReactionsContainerLayout.ReactionHolderView) {
                                    ...
                                    if (imageViewEmoji2 != null) {
                                        ...
                                        float y2 = (((imageViewEmoji2.getY() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getY()) + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.gridViewContainer.getY()) + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getY()) - reactionHolderView.loopImageView.getY();
                                        ...
                                        if (reactionHolderView.position == 0) {
                                            ...
                                            if (f6 == 0.0f && f18 == 0.0f) {
                                                ...
                                                f6 = AndroidUtilities.lerp((customEmojiReactionsWindow7.fromRect.left + x2) - x3, 0.0f, customEmojiReactionsWindow7.enterTransitionProgress);
                                                CustomEmojiReactionsWindow customEmojiReactionsWindow8 = CustomEmojiReactionsWindow.this;
                                                f18 = AndroidUtilities.lerp((customEmojiReactionsWindow8.fromRect.top + y) - y2, 0.0f, customEmojiReactionsWindow8.enterTransitionProgress);
                                        ...
                                        if (f6 == 0.0f) {
                                            ...
                                            f6 = AndroidUtilities.lerp((customEmojiReactionsWindow72.fromRect.left + x2) - x3, 0.0f, customEmojiReactionsWindow72.enterTransitionProgress);
                                            CustomEmojiReactionsWindow customEmojiReactionsWindow82 = CustomEmojiReactionsWindow.this;
                                            f18 = AndroidUtilities.lerp((customEmojiReactionsWindow82.fromRect.top + y) - y2, 0.0f, customEmojiReactionsWindow82.enterTransitionProgress);
                                            f19 = AndroidUtilities.lerp(1.0f / measuredWidth2, 1.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                            f20 = x3;
                                            f21 = y2;
                                        }
                                    ...
                                    canvas.translate(x4, (y3 + customEmojiReactionsWindow9.fromRect.top) - customEmojiReactionsWindow9.drawingRect.top);
                                    i2 = i7;
