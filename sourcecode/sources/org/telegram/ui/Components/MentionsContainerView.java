        ...
        if (z) {
            ...
            if (!this.shown) {
                ...
                if (layoutManager == linearLayoutManager) {
                    linearLayoutManager.scrollToPositionWithOffset(0, isReversed ? -100000 : BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
                }
                if (getVisibility() == 8) {
                    this.hideT = 1.0f;
    ...
    public class MentionsListView extends RecyclerListView {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (MentionsContainerView.this.scrollToFirst) {
                ...
                currentLayoutManager.scrollToPositionWithOffset(0, BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
