        ...
        public void draw(Canvas canvas) {
            ...
            if (snowflakesEffect.particleBitmap == null) {
                ...
                while (i < 6) {
                    ...
                    double d = f;
                    float cos2 = ((float) Math.cos(d)) * dpf2;
                    float sin = ((float) Math.sin(d)) * dpf2;
                    float f3 = cos2 * 0.66f;
                    canvas2.drawLine(dp, dp2, dp + cos2, dp2 + sin, SnowflakesEffect.this.particleThinPaint);
                    ...
                    canvas3.drawLine(f4, f5, dp + ((float) ((Math.cos(d2) * d3) - (Math.sin(d2) * d4))), dp2 + ((float) ((Math.sin(d2) * d3) + (Math.cos(d2) * d4))), SnowflakesEffect.this.particleThinPaint);
                    canvas3.drawLine(f4, f5, dp + ((float) (((-Math.cos(d2)) * d3) - (Math.sin(d2) * d4))), dp2 + ((float) (((-Math.sin(d2)) * d3) + (Math.cos(d2) * d4))), SnowflakesEffect.this.particleThinPaint);
                    f += 1.0471976f;
                    i++;
                    canvas2 = canvas3;
            ...
            for (int i5 = 0; i5 < i4; i5++) {
                if (this.particles.size() < i3 && Utilities.random.nextFloat() > 0.7f) {
                    ...
                    if (this.viewType == 0) {
                        ...
                        particle.lifeTime = Utilities.random.nextInt(2000) + BannerConfig.LOOP_TIME;
                    }
