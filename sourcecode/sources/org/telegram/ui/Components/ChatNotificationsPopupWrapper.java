...
public class ChatNotificationsPopupWrapper {
    ...
    public void showAsOptions(BaseFragment baseFragment, View view, float f, float f2) {
        ...
        this.windowLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), LinearLayoutManager.INVALID_OFFSET), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(1000.0f), LinearLayoutManager.INVALID_OFFSET));
