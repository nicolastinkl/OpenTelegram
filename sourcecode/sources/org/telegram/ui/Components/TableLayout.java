...
public class TableLayout extends View {
        ...
        */
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (TableLayout.this.drawLines) {
                ...
                float f13 = (z3 && (i = this.y) == 0) ? i + dp : this.y - strokeWidth;
                if (z3 && z4) {
                ...
                int i10 = this.x;
                float f15 = (i10 == 0 && z4) ? i10 + dp : i10 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i10 + this.measuredWidth) - dp;
                } else {
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        setRowCount(LinearLayoutManager.INVALID_OFFSET);
        setColumnCount(LinearLayoutManager.INVALID_OFFSET);
        setOrientation(0);
    ...
    final class Axis {
        ...
        private Axis(boolean z) {
            this.definedCount = LinearLayoutManager.INVALID_OFFSET;
        ...
        public int getMeasure(int i) {
            ...
            if (mode == 0) {
                return getMeasure(0, BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH);
            }
            if (mode != 1073741824) {
                return 0;
            }
    ...
    static class Bounds {
        ...
        protected int size(boolean z) {
            return (z || !TableLayout.canStretch(this.flexibility)) ? this.before + this.after : BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH;
        }
    ...
    public static class Spec {
        static final Spec UNDEFINED = TableLayout.spec(LinearLayoutManager.INVALID_OFFSET);
