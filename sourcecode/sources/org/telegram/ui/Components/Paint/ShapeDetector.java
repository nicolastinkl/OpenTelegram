...
public class ShapeDetector {
    ...
    private ArrayList<Point> resample(ArrayList<Point> arrayList, int i) {
        ...
        while (i4 < arrayList.size()) {
            ...
            if (d3 >= pathLength) {
                ...
                i2 = i3;
                d = pathLength;
                Point point = new Point(arrayList.get(i5).x + ((arrayList.get(i4).x - arrayList.get(i5).x) * d4), arrayList.get(i5).y + (d4 * (arrayList.get(i4).y - arrayList.get(i5).y)));
    ...
    private double distanceAtAngle(ArrayList<Point> arrayList, Point point, ArrayList<Point> arrayList2, double d) {
        ...
        while (i < min) {
            ...
            double d6 = point2.y;
            double d7 = cos2;
            d2 += point4.distance((((d3 - d4) * cos2) - ((d5 - d6) * sin)) + d4, ((d3 - d4) * sin) + ((d5 - d6) * d7) + d6);
            i = i2 + 1;
            point2 = point;
            min = i3;
            cos2 = d7;
    ...
    private void rotate(ArrayList<Point> arrayList, double d, Point point) {
        ...
        while (i < arrayList.size()) {
            ...
            int i2 = i;
            double d5 = point.y;
            point2.y = ((d2 - d3) * sin) + ((d4 - d5) * cos2) + d5;
            point2.x = (((d2 - d3) * cos2) - ((d4 - d5) * sin)) + d3;
            i = i2 + 1;
        }
    }
