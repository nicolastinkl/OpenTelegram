...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        hashMap14.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "clear", "color", "type", "color", "resolution", "center", "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
