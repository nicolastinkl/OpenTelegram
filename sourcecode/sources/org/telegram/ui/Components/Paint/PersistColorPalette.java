...
public class PersistColorPalette {
    ...
    private static PersistColorPalette[] instances = new PersistColorPalette[1];
    ...
    public void selectColor(int i) {
        ...
        this.pendingChange.remove(r3.size() - 1);
    }
    ...
    private void loadColors() {
        for (int i = 0; i < 14; i++) {
            this.colors.add(Integer.valueOf((int) this.mConfig.getLong("color_" + i, DEFAULT_COLORS.get(i).intValue())));
        }
