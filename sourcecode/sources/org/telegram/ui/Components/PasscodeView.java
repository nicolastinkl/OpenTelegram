...
public class PasscodeView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x004f -> B:24:0x005d). Please report as a decompilation issue!!! */
    ...
    public void onShow(boolean z, boolean z2, int i, int i2, Runnable runnable, Runnable runnable2) {
        ...
        } else if (d.a.equals(Theme.getSelectedBackgroundSlug()) || Theme.isPatternWallpaper()) {
