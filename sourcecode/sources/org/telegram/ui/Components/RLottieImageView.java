...
public class RLottieImageView extends ImageView {
    ...
    public void setAnimation(TLRPC$Document tLRPC$Document, final int i, final int i2) {
        ...
        if (this.onlyLastFrame) {
            imageReceiver2.setImage(ImageLocation.getForDocument(tLRPC$Document), i + "_" + i2 + "_lastframe", null, null, null, null, null, 0L, null, tLRPC$Document, 1);
        } else {
            if ("video/webm".equals(tLRPC$Document.mime_type)) {
                ...
                imageReceiver3.setImage(forDocument, sb.toString(), ImageLocation.getForDocument(closestPhotoSizeWithSize, tLRPC$Document), null, null, tLRPC$Document.size, null, tLRPC$Document, 1);
            } else {
                ...
                imageReceiver4.setImage(forDocument2, sb2.toString(), ImageLocation.getForDocument(closestPhotoSizeWithSize2, tLRPC$Document), null, null, null, svgThumb, 0L, null, tLRPC$Document, 1);
            }
        }
