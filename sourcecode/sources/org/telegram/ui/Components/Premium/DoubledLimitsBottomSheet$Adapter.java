...
public class DoubledLimitsBottomSheet$Adapter extends RecyclerListView.SelectionAdapter {
    ...
    public DoubledLimitsBottomSheet$Adapter(int i, boolean z) {
        ...
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString("ConnectedAccountsLimitTitle", R.string.ConnectedAccountsLimitTitle), LocaleController.formatString("ConnectedAccountsLimitSubtitle", R.string.ConnectedAccountsLimitSubtitle, 4), 1, 1, null));
        this.rowCount = 0;
        int i2 = 1 + 0;
        this.rowCount = i2;
        this.headerRow = 0;
    ...
    public void measureGradient(Context context, int i, int i2) {
        ...
        for (int i4 = 0; i4 < this.limits.size(); i4++) {
            ...
            doubledLimitsBottomSheet$LimitCell.measure(View.MeasureSpec.makeMeasureSpec(i, 1073741824), View.MeasureSpec.makeMeasureSpec(i2, LinearLayoutManager.INVALID_OFFSET));
