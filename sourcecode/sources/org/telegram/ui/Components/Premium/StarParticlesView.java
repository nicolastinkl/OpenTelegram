    ...
    public static class Drawable {
        ...
        public class Particle {
            ...
            public void draw(Canvas canvas, long j, float f) {
                ...
                if (!z) {
                    ...
                    if (Drawable.this.checkTime) {
                        if (this.lifeTime - j < 200) {
                            f3 = Utilities.clamp(1.0f - ((r4 - j) / 150.0f), 1.0f, 0.0f);
                        }
                    }
                    Drawable drawable2 = Drawable.this;
            ...
            public void genPosition(long j) {
                ...
                this.lifeTime = j + Drawable.this.minLifeTime + Utilities.fastRandom.nextInt(r0.randLifeTime);
                this.randomRotate = 0.0f;
                Drawable drawable = Drawable.this;
                if (drawable.distributionAlgorithm) {
                    float abs = drawable.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                    ...
                    this.x = Drawable.this.rect.centerX() + ((float) (Math.sin(Math.toRadians(r4)) * abs5));
                    this.y = Drawable.this.rect.centerY() + ((float) (abs5 * Math.cos(Math.toRadians(r4))));
                } else {
