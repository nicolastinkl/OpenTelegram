            ...
            if (i >= 0) {
                ...
                for (int i3 = 0; i3 < tLRPC$Document.thumbs.size(); i3++) {
                    if (tLRPC$Document.thumbs.get(i3) instanceof TLRPC$TL_photoStrippedSize) {
                        this.roundedBitmapDrawable = RoundedBitmapDrawableFactory.create(getResources(), ImageLoader.getStrippedPhotoBitmap(tLRPC$Document.thumbs.get(i3).bytes, b.a));
                ...
                if (matrixParticlesDrawable != null) {
                    ...
                    if (drawable != null) {
                        ...
                        if (this.videoPlayer != null) {
                            float clamp = Utilities.clamp(r5.getCurrentPosition() / this.videoPlayer.getDuration(), 1.0f, 0.0f);
