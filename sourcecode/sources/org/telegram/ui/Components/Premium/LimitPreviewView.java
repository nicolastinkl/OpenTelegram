...
public class LimitPreviewView extends LinearLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.wasAnimation && this.limitIcon != null && this.animationCanPlay && !this.premiumLocked) {
            ...
            float measuredWidth = (dp + ((getMeasuredWidth() - (dp * 2)) * this.position)) - (this.limitIcon.getMeasuredWidth() / 2.0f);
            final float f3 = 0.5f;
            if (measuredWidth > (getMeasuredWidth() - dp) - this.limitIcon.getMeasuredWidth()) {
                f = (getMeasuredWidth() - dp) - this.limitIcon.getMeasuredWidth();
                f2 = 1.0f;
            } else {
                f = measuredWidth;
                f2 = 0.5f;
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Premium.LimitPreviewView$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    LimitPreviewView.this.lambda$onLayout$0(f4, f5, f3, f6, valueAnimator);
                }
            });
        ...
        if (this.premiumLocked) {
            float dp2 = (AndroidUtilities.dp(14.0f) + ((getMeasuredWidth() - (r0 * 2)) * 0.5f)) - (this.limitIcon.getMeasuredWidth() / 2.0f);
    ...
    public /* synthetic */ void lambda$onLayout$0(float f, float f2, float f3, float f4, ValueAnimator valueAnimator) {
        ...
        this.limitIcon.setPivotX(r5.getMeasuredWidth() * f6);
    }
    ...
    public void setType(int i) {
        ...
        if (i == 11) {
            if (this.limitIcon != null) {
                ...
                spannableStringBuilder2.append((CharSequence) d.a).setSpan(new ColoredImageSpan(this.icon), 0, 1, 0);
