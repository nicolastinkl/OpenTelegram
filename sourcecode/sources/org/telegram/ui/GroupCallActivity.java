...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    */
    ...
    private GroupCallActivity(final Context context, final AccountInstance accountInstance, ChatObject.Call call, final TLRPC$Chat tLRPC$Chat, TLRPC$InputPeer tLRPC$InputPeer, boolean z, String str) {
        ...
        if (tLRPC$InputPeer != null) {
            ...
            this.scheduleTimerContainer.addView(numberPicker, LayoutHelper.createLinear(0, SubsamplingScaleImageView.ORIENTATION_270, 0.5f));
            ...
            this.scheduleTimerContainer.addView(numberPicker2, LayoutHelper.createLinear(0, SubsamplingScaleImageView.ORIENTATION_270, 0.2f));
            ...
            this.scheduleTimerContainer.addView(numberPicker3, LayoutHelper.createLinear(0, SubsamplingScaleImageView.ORIENTATION_270, 0.3f));
    ...
    class AnonymousClass17 extends FrameLayout {
        ...
        /* JADX WARN: Removed duplicated region for block: B:159:0x07f0  */
        /* JADX WARN: Removed duplicated region for block: B:167:0x08a0  */
        /* JADX WARN: Removed duplicated region for block: B:170:0x0902  */
        /* JADX WARN: Removed duplicated region for block: B:175:0x0952  */
        /* JADX WARN: Removed duplicated region for block: B:178:0x095f  */
        /* JADX WARN: Removed duplicated region for block: B:181:0x09c8  */
        /* JADX WARN: Removed duplicated region for block: B:186:0x09e5  */
        /* JADX WARN: Removed duplicated region for block: B:193:0x0a54 A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:194:0x09dd A[ADDED_TO_REGION] */
    ...
    public /* synthetic */ void lambda$new$35(Context context, View view) {
        ...
        if (VoIPService.getSharedInstance().getVideoState(false) != 2) {
            ...
            if (this.previewDialog == null) {
                ...
                PrivateVideoPreviewDialog privateVideoPreviewDialog = new PrivateVideoPreviewDialog(context, z, VoIPService.getSharedInstance().getVideoState(true) != 2) { // from class: org.telegram.ui.GroupCallActivity.38
    ...
    public void show() {
        NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.stopAllHeavyOperations, Integer.valueOf(LiteMode.FLAG_AUTOPLAY_GIFS));
        super.show();
    ...
    public void dismissInternal() {
        ...
        NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.startAllHeavyOperations, Integer.valueOf(LiteMode.FLAG_AUTOPLAY_GIFS));
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:228:0x02d1, code lost:
        ...
        if ((r9 instanceof org.telegram.tgnet.TLRPC$TL_chatParticipantCreator) == false) goto L113;
     */
    /* JADX WARN: Code restructure failed: missing block: B:235:0x02eb, code lost:
    
        if (r3 == (-r28.currentChat.id)) goto L112;
     */
        ...
        */
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                boolean z = false;
                if (i == 4) {
                    view = new GroupCallGridCell(this.mContext, z) { // from class: org.telegram.ui.GroupCallActivity.ListAdapter.4
