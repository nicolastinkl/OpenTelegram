...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        httpURLConnection.setRequestProperty(Headers.USER_AGENT, String.format("datatransport/%s android/", "3.1.0"));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.i("CctTransportBackend", "Content-Type: " + httpURLConnection.getHeaderField(Headers.CONTENT_TYPE));
